        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    ...
                    actions = {
                        ...
                        val isLocalModelAvailable by remember { mutableStateOf(chatViewModel.isLocalModelAvailable()) }
                        val isRemoteModelAvailable by remember { mutableStateOf(chatViewModel.isRemoteModelAvailable()) }
                        ...
                        TooltipBox(
                            ...
                            tooltip = {
                                Text(
                                    text = when {
                                        isLocalModelAvailable -> "Using Local LLM (Qwen2.5-1.5B)"
                                        isRemoteModelAvailable -> "Using Remote LLM (Gemini)"
                            ...
                            Icon(
                                imageVector = when {
                                    isLocalModelAvailable -> Icons.Default.Computer
                                    isRemoteModelAvailable -> Icons.Default.Cloud
                                    else -> Icons.Default.Key
                                },
                                contentDescription = "LLM Status",
                                tint = when {
                                    isLocalModelAvailable -> Color.Green
                                    isRemoteModelAvailable -> Color.Blue
                                    else -> Color.Red
                                },
            ...
            Column(modifier = Modifier.padding(innerPadding).padding(16.dp).fillMaxWidth()) {
                ...
                Column {
                    ...
                    QueryInput(chatViewModel, onEditAPIKeyClick, onModelDownloadClick)
                }
            }
            AppAlertDialog()
        }
